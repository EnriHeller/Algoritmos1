def mi_funcion(x1, y1, z1, x2, y2, z2):
    ...
    var1 = y1*z2 - z1*y2
    #var2 = z1**x2 - x1*z2 -> Linea debuggeada
    var2 = z1*x2 - x1*z2 
    var3 = x1*y2 - y1*x2
    return var1, var2, var3

assert mi_funcion(54, 12, 29, 1, 11, 12) == (-175, -619, 582)
#print(mi_funcion(71, 52, 24, 1, 11, 6))
...
#4.7) ¿Se puede escribir el cuerpo de la función en una línea? ¿Cómo?:

def producto_vectorial_v2(x1, y1, z1, x2, y2, z2): return (y1*z2 - z1*y2, z1*x2 - x1*z2, x1*y2 - y1*x2)
